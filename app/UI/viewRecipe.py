...
"border-radius: 15px;")
        ...
        self.inCal_label.setGeometry(QRect(90, 110, 31, 20))
        ...
        self.Kcal_label = QLabel(self.widget)
        self.Kcal_label.setObjectName(u"Kcal_label")
        self.Kcal_label.setGeometry(QRect(130, 110, 81, 16))
        ...
        self.inLevel_label.setGeometry(QRect(90, 80, 91, 16))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 261, 109))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 261, 219))
...
#         self.commet_lineEdit.setStyleSheet(u"background-color: rgb(255, 223, 202);")
    ...
    def retranslateUi(self, Form):
        ...
        self.Kcal_label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" color:#ff9300;\">Kilocalories</span></p></body></html>", None))
